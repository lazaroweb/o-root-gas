...
export default function SearchModal({ open, onClose, onSelect, onNavigate, onImportGAS, onSkillsOpen }: SearchModalProps): React.ReactElement {
  ...
  const commands: Command[] = useMemo(() => {
    ...
    return [
      ...
      { id: 'nav-operacoes', label: 'Ao vivo', hint: 'Saúde, status, APIs, GitHub', keywords: 'ao vivo operacoes status api github monitor uptime saude conexoes', icon: i(<Activity size={16} strokeWidth={1.6} />), color: t.accents.sage, run: () => go('operacoes') },
